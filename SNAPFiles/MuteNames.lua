...
if DevAbs:get(SNAP.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(SNAP.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(SNAP.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(SNAP.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(SNAP.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(SNAP.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
SNAPName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if SNAPName then 
SNAPNames = DevAbs:smembers(SNAP.."Abs:Mute:Names"..msg.chat_id_) or ""
if SNAPNames and SNAPNames[1] then 
for i=1,#SNAPNames do 
if SNAPName:match("(.*)("..SNAPNames[i]..")(.*)") then 
...
DevAbs:set(SNAP.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(SNAP.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
